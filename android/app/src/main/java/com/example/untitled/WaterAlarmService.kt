...
class WaterAlarmService : Service() {
    ...
    companion object {
        const val ACTION_START_ALARM_SERVICE = "com.example.untitled.ACTION_START_ALARM_SERVICE"
        const val ACTION_STOP_ALARM_SERVICE = "com.example.untitled.ACTION_STOP_ALARM_SERVICE"
